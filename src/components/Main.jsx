...
export default function Main() {
    ...
    return (
        ...
        <div className='flex flex-row mt-4 ml-5'>
            <button className={`h-12 w-64 font-medium border-b-4 ${overview}`} onClick={overviewFunc}>
                <Link to="/">OverView</Link>
            </button>
            <hr />
            <button className={`h-12 w-64 font-medium border-b-4 ${other}`} onClick={otherFunc}>
